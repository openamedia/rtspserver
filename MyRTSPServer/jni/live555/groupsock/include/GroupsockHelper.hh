...
//jim: cancel the extern c for c++.
/*extern "C"*/ netAddressBits our_inet_addr(char const*);
/*extern "C"*/ void our_srandom(unsigned int x);//jim: strict c++ can not bear the default type convertion in c from int to unsigned int.
